...
public class SomaticGenotypingEngine extends AssemblyBasedCallerGenotypingEngine {
    ...
    public CalledHaplotypes callMutations(
        ...
        // is not what we want.
        final List<Integer> startPosKeySet = decomposeHaplotypesIntoVariantContexts(haplotypes, assemblyResultSet.getFullReferenceWithPadding(), assemblyResultSet.getPaddedReferenceLoc(), Collections.emptyList(), MTAC.splitMnps).stream()
